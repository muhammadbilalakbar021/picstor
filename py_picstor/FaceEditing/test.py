...
def parse(args=None):
    ...
    parser.add_argument('--experiment_name', dest='experiment_name', default='128_shortcut1_inject1_none')
    ...
    parser.add_argument('--custom_img', action='store_true', default='../pics/test.jpg')
...
for idx, (img_a, att_a) in enumerate(test_dataloader):
    ...
    with torch.no_grad():
        ...
        print("1122"+join(output_path, out_file))
        vutils.save_image(
